...
import { GroupSettlementDetail } from "@/components/group-settlement-detail";
...
export function GroupBalanceSummary({ expenses, groupMembers, groupName, currentUserId }: GroupBalanceSummaryProps) {
  ...
  return (
    <>
      <Card className="mb-4 cursor-pointer hover:bg-muted/30 transition-colors" onClick={() => setDetailOpen(true)}>
        ...
        <CardContent className="px-4 pb-4 pt-0">
          ...
          <p className="text-[10px] text-muted-foreground mt-2">
            Positivo = tem a receber · Negativo = deve pagar · Toque para detalhes
          </p>
        </CardContent>
      </Card>

      <GroupSettlementDetail
        open={detailOpen}
