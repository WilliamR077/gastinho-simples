...
import getNotificationSettings from "./tools/get-notification-settings";
import updateNotificationSettings from "./tools/update-notification-settings";
...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Use get_notification_settings para distinguir preferências persistidas dos defaults efetivos; update_notification_settings altera somente os quatro toggles exibidos na interface e nunca envia notificações, consulta tokens ou verifica permissões do dispositivo. " +
    "Use get_profile para ler display_name e updated_at sem expor identidade de autenticação; use update_profile somente com o updated_at lido, exceto na criação inicial de perfil ausente. " +
