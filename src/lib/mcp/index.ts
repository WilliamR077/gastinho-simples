...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Ferramentas do Gastinho Simples. Use list_categories para descobrir UUIDs de categorias, list_expenses/list_incomes para consultar transações, create_expense/create_income para registrar, e get_summary para totais e saldo do período.",
