...
assert.match(source, /name:\s*"list_shared_groups"/u);
assert.match(source, /name:\s*"list_shared_group_members"/u);
assert.match(source, /name:\s*"get_expense_split_details"/u);
